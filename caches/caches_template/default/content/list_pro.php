...
<div class="outW">
    ...
    <div class="loca" id="content">
         ...
         <p class="locaSer">
            ...
            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=a9e1ea5a14ca12b7e81e20b8498b55f6&action=category&catid=%24parentid&siteid=%24siteid&order=listorder+ASC&num=l6\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$data = $content_tag->category(array('catid'=>$parentid,'siteid'=>$siteid,'order'=>'listorder ASC','limit'=>'20',));}?>
