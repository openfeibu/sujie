...
/*样式隐藏*/
/*phpsso 用户 界面 扩展 视频*/
#_M8,#_M5,#_M6,#_M7,#_M9{display:none}
/*设置*/
#_MP65,#_MP959,#_MP979,#_MP980,#_MP981,#_MP1093{display:none}
/*模块*/
#_MP1663,#_MP1594,#_MP1612,#_MP1625,#_MP1627,#_MP1649,#_MP896,#_MP1557,#_MP1535,#_MP1533,#__MP1520,#__MP1502,#__MP1571,#__MP902,#__MP909,#__MP982,#_MP1528,#_MP1520,#_MP1571,#_MP902,#_MP909,#_MP982,#_MP1502,#_MP1508{display:none}
/*内容*/
    ...
    <?php echo L('current_position')?><span id="current_pos"></span></div>
    	<div class="col-1">
        	<div class="content" style="position:relative; overflow:hidden">
                <iframe name="right" id="rightMain" src="welcome.html" frameborder="false" scrolling="auto" style="border:none; margin-bottom:30px" width="100%" height="auto" allowtransparency="true"></iframe>
                <!--<div class="fav-nav">
					<div id="panellist">
