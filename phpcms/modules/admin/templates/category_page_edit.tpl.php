...
<tr>
	...
	<tr style="display:none">
     <th>是否系统栏目：</th>
      <td>
	  <input type='radio' name='info[issys]' value='1' <?php if($issys) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[issys]' value='0' <?php if(!$issys) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
</table>
