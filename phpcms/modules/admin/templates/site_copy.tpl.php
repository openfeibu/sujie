...
<div class="pad-10">
<form action="?m=admin&c=site&a=copy" method="post" id="myform">
<div>
<fieldset>
	<legend><?php echo L('basic_configuration')?></legend>
	<table width="100%"  class="table_form">
	<tr>
    <th width="80"><?php echo L('复制的站点')?>：</th>
	<td class="y-bg"><?php echo form::select($sitelist, $siteid, 'name="copy_siteid"');?></td>
	</tr>
  <tr>
