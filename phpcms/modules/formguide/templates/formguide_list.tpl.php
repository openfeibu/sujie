...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
			...
			<th width="160" align="center" class="d_h"><?php echo L('call')?></th>
