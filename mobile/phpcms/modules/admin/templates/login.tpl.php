...
<html>
	...
	<body>
		<header>
			<div class="con-header clearfix hide">
			<div id="logo" class="leftfloat"><a href="index.html"><img src="<?php echo IMG_PATH?>images/logo.png" /></a></div>
			<div class="text rightfloat">服务热线：020-38325452</div>
			<nav class="rightfloat">
				<ul>
					<li><a href="http://wpa.qq.com/msgrd?v=3&uin=2036231683&site=qq&menu=yes"  target="_blank">网站运营</a></li>
					<li><a href="http://weixin.npower2010.com/"  target="_blank">微信营销</a></li>
					<li><a href="http://www.npower2010.com/html/news/"  target="_blank">哲启社区</a></li>
					<li><a href="http://www.npower2010.com/html/about/contact/"  target="_blank">联系我们</a></li>
				</ul>
			</nav>
			</div>
		</header>
		<section class="clearfix">
			<div class="cloud hide"></div>
			<div class="text hide"><a href="#" class="opacity"></a></div>
		...
		<footer>
			<div id="footer">
				<a href="http://www.npower2010.com" target="_blank">哲启科技</a>
				<a href="http://www.npower2010.com/html/about/" target="_blank">关于哲启</a>
				<a href="http://www.npower2010.com/html/about/contact/" target="_blank">联系哲启</a>
				Power By <a href="http://www.npower2010.com" style="margin: 0;">www.npower2010.com</a>
			</div>
		</footer>
	</body>
</html>
