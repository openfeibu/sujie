...
define('ROOT_PC_PATH', str_replace(DIRNAME.DIRECTORY_SEPARATOR, '', dirname(__FILE__).DIRECTORY_SEPARATOR));
if(!defined('PHPCMS_PATH')) define('PHPCMS_PATH', PC_PATH.'..'.DIRECTORY_SEPARATOR);
if(!defined('ROOT_PATH')) define('ROOT_PATH', str_replace(DIRNAME.DIRECTORY_SEPARATOR,'',PC_PATH.'..'.DIRECTORY_SEPARATOR));
...
//当前访问的主机名
define('SITE_URL', (isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'].'/'.DIRNAME : ''));
//来源
...
//rec 路径
define('REC_PATH',pc_base::load_config('system','rec_path'));
//动态程序路径
